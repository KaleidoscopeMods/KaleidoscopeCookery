...
public interface PotRecipeSchema {
    ...
    RecipeKey<List<Ingredient>> INGREDIENTS = ListRecipeComponent.create(IngredientComponent.INGREDIENT.instance(), true, false).inputKey("ingredients"); //IngredientComponent.INGREDIENT.inputKey("ingredients");
