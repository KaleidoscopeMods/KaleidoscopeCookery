...
public class PotScenes {
    public static void introduction(SceneBuilder scene, SceneBuildingUtil util){
        ...
        scene.idle(43);
        scene.overlay().showControls(util.vector().blockSurface(potPos,Direction.UP), Pointing.DOWN, 35).withItem(new ItemStack(BuiltInRegistries.ITEM.get(new ResourceLocation(KaleidoscopeCookery.MOD_ID,"spicy_chicken"))));
        scene.idle(40);
    }
}
