...
public class BambooTrayRecipeCategory implements IRecipeCategory<RecipeHolder<BambooTrayRecipe>> {
    public static final RecipeType<RecipeHolder<BambooTrayRecipe>> TYPE = RecipeType.createRecipeHolderType(
            ResourceLocation.fromNamespaceAndPath(KaleidoscopeCookery.MOD_ID, "bamboo_tray"));

    private static final ResourceLocation BG = ResourceLocation.fromNamespaceAndPath(KaleidoscopeCookery.MOD_ID, "textures/gui/jei/bamboo_tray.png");
    ...
    public static List<RecipeHolder<BambooTrayRecipe>> getRecipes() {
    ...
    @Override
    public void draw(RecipeHolder<BambooTrayRecipe> recipeHolder, IRecipeSlotsView recipeSlotsView, GuiGraphics guiGraphics, double mouseX, double mouseY) {
        this.bgDraw.draw(guiGraphics);
        BambooTrayRecipe recipe = recipeHolder.value();
    ...
    @Override
    public void setRecipe(IRecipeLayoutBuilder builder, RecipeHolder<BambooTrayRecipe> recipeHolder, IFocusGroup focuses) {
        BambooTrayRecipe recipe = recipeHolder.value();
    ...
    @Override
    public RecipeType<RecipeHolder<BambooTrayRecipe>> getRecipeType() {
        return TYPE;
    }
