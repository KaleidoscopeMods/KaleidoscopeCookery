...
public class EmiBambooTrayRecipe extends BasicEmiRecipe {
    public static final EmiRecipeCategory CATEGORY = new EmiRecipeCategory(
            ResourceLocation.parse(ModRecipes.BAMBOO_TRAY_RECIPE.toString()),
    ...
    public static void register(EmiRegistry registry) {
        ...
        registry.getRecipeManager().getAllRecipesFor(ModRecipes.BAMBOO_TRAY_RECIPE).forEach(recipeHolder -> {
            ...
            registry.addRecipe(new EmiBambooTrayRecipe(recipeHolder.id(), inputs, outputs,
