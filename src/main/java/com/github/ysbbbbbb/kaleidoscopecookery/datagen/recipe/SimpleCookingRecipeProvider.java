...
public class SimpleCookingRecipeProvider extends ModRecipeProvider {
    ...
    public void buildRecipes(RecipeOutput consumer) {
        ...
        simpleCookingRecipe(consumer, "campfire_cooking", RecipeSerializer.CAMPFIRE_COOKING_RECIPE, CampfireCookingRecipe::new,
                600, ModItems.FRESH_TEA_LEAVES.get(), ModItems.DRIED_TEA_LEAVES.get(), 0.1F);
        simpleCookingRecipe(consumer, "smelting", RecipeSerializer.SMELTING_RECIPE, SmeltingRecipe::new,
                200, ModItems.FRESH_TEA_LEAVES.get(), ModItems.DRIED_TEA_LEAVES.get(), 0.1F);
    }
