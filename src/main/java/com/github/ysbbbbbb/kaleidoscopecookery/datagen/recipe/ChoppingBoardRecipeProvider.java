...
public class ChoppingBoardRecipeProvider extends ModRecipeProvider {
    ...
    public void buildRecipes(RecipeOutput consumer) {
        ChoppingBoardBuilder.builder()
                ...
                .setResult(ModItems.RAW_LAMB_CHOPS.get(), 3)
                .setCutCount(4)
        ...
        ChoppingBoardBuilder.builder()
                ...
                .setResult(ModItems.COOKED_LAMB_CHOPS.get(), 3)
                .setCutCount(4)
        ...
        ChoppingBoardBuilder.builder()
                ...
                .setResult(ModItems.SASHIMI.get(), 3)
                .setCutCount(4)
        ...
        ChoppingBoardBuilder.builder()
                ...
                .setResult(ModItems.RAW_COW_OFFAL.get(), 3)
                .setCutCount(4)
        ...
        ChoppingBoardBuilder.builder()
                ...
                .setResult(ModItems.COOKED_COW_OFFAL.get(), 3)
                .setCutCount(4)
        ...
        ChoppingBoardBuilder.builder()
                ...
                .setResult(ModItems.RAW_PORK_BELLY.get(), 3)
                .setCutCount(4)
        ...
        ChoppingBoardBuilder.builder()
                ...
                .setResult(ModItems.COOKED_PORK_BELLY.get(), 3)
                .setCutCount(4)
        ...
        ChoppingBoardBuilder.builder()
                ...
                .setResults(new ItemStack(ModItems.RAW_CUT_SMALL_MEATS.get(), 3), new ItemStack(Items.BONE))
                .setCutCount(4)
        ...
        ChoppingBoardBuilder.builder()
                ...
                .setResults(new ItemStack(ModItems.COOKED_CUT_SMALL_MEATS.get(), 3), new ItemStack(Items.BONE))
                .setCutCount(4)
        ...
        ChoppingBoardBuilder.builder()
                ...
                .setResult(ModItems.RAW_NOODLES.get(), 3)
                .setCutCount(4)
